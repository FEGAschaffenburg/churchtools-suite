...
### Fixes
- Der Auto-Updater installiert nur noch das geprüfte WordPress-Release-ZIP.
- GitHub-Source-Archive und beliebige ZIP-Fallbacks werden nicht mehr verwendet.
- Fehlerhafte temporäre Plugin-Verzeichnisse mit zufälligem Suffix werden dadurch verhindert.
