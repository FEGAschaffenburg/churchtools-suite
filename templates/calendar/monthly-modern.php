...
<div class="cts-calendar cts-calendar-monthly" 
	...
	<div class="cts-calendar-header">
		<button class="cts-nav-btn cts-prev-month cts-arrow-left" aria-label="<?php esc_attr_e( 'Vorheriger Monat', 'churchtools-suite' ); ?>"></button>
		...
		<button class="cts-nav-btn cts-next-month cts-arrow-right" aria-label="<?php esc_attr_e( 'Nächster Monat', 'churchtools-suite' ); ?>"></button>
	</div>
