...
<div class="cts-calendar cts-calendar-monthly" 
	...
	<div class="cts-calendar-header">
		<button class="cts-nav-btn cts-prev-month" aria-label="<?php esc_attr_e( 'Vorheriger Monat', 'churchtools-suite' ); ?>"><span style="font-size: 18px; font-family: Arial, sans-serif; pointer-events: none;">◀</span></button>
		...
		<button class="cts-nav-btn cts-next-month" aria-label="<?php esc_attr_e( 'Nächster Monat', 'churchtools-suite' ); ?>"><span style="font-size: 18px; font-family: Arial, sans-serif; pointer-events: none;">▶</span></button>
	</div>
